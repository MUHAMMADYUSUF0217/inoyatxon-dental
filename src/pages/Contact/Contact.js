            ...
            <div className="row gx-sm-0 gx-md-2 gx-lg-5">
                <div className="col-md-6">
                    <div className="d-flex justify-content-center w-100">
                        ...
                        <h3 className="header_color fw-bolder">Bizga <span className="span_color">Xabaringizni</span>Jo'nating</h3>
                        <p className="mb-4">Tez orada siz bilan bog'lanamiz</p>
                        <div className="text-start">
                            ...
                            <div>
                            <label className="form-label mt-3">Xabaringiz</label>
