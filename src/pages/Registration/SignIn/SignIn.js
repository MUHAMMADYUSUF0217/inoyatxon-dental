...
const SignIn = () => {
    ...
    const handleEmailChange = e => {
        ...
        if(validEmail) {
            ...
            setLoginError('Iltimos togri emailni kiriting');
        };
    };
    const handlePasswordChange = e => {
        ...
        if(inputValue.length >= 6) {
            ...
            setLoginError('Password 6 ta belgi bo`lishi kerak');
        };
    };
    const handleConfirmPassword = e => {
        ...
        if(inputValue === password) {
            ...
            setLoginError('Parollar mos kelmadi');
        };
    };
    ...
    const goSignIn = () => {
        ...
        .catch(error => {
            ...
            if(error.message === invalidUser) {
                setLoginError('Iltimos emailni tekshiring');
            }
            else if(error.message === invalidPassword) {
                setLoginError('Iltimos parolni togri kiriting');
            };
        })
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="bg-white p-3 mt-5">
                            <form onSubmit={handleSubmission}>
                                <h2 className="fw-bold text-title">{isSignin ? "Login qiling" : "Registratsiya qiling"}</h2>
                                <h6 className="light-text">
                                    {isSignin ? " Accountingiz yo'qmi " : " Accountingiz bormi ? "} 
                                    <span className="text-primary" onClick={handleIsSignin}>
                                        {isSignin ? "Registratsiya qiling" : "Login qiling"}
                                    </span>
                                </h6>
                                <div className="w-75 mx-auto mt-3">
                                    ...
                                    <Button type="submit" variant="primary w-100 py-2 mt-3">{isSignin ? "Login" : "Registratsiya"}</Button>
